...
# --- 4. Company Register (核心優化：Others 強制驗證) ---
    ...
    round_l = l1.text_input(red_label("Round", d['rl']), value=d['rl'])
    sign_l = l2.text_input(red_label("Sign", d['sl']), value=d['sl'])
    common_l = l3.text_input(red_label("Common", d['cl']), value=d['cl'])
...
# --- 鎖定部分：Dashboard, Group Management, Data Exchange 保持 V42/V45 原貌 ---
# ... (略去重複內容以節省篇幅，確保與 V45 邏輯一致) ...
