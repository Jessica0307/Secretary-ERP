...
# --- 5. Dashboard (維持 V38 鎖定邏輯) ---
    ...
    if not df_raw.empty:
        ...
        edited_df = st.data_editor(
            ...
            hide_index=True, use_container_width=True, key="dashboard_editor_v42"
        )
...
# --- 其他 Section (Register, Group, Exchange) 保持鎖定邏輯 ---
# ... (代碼保持 V32 以來的穩定結構)
