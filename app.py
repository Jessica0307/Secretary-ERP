...
def generate_custom_pdf(selected_df):
    ...
    # CSS 核心修正：引入 Google Fonts 確保雲端環境有中文字型
    html_content = f"""
    <html>
    <head>
        <meta charset="UTF-8">
...
# --- 5. Dashboard (維持 V38 的純日期顯示邏輯) ---
    ...
    if not df_raw.empty:
        ...
        edited_df = st.data_editor(
            ...
            hide_index=True, use_container_width=True, key="dashboard_editor_v40"
        )
